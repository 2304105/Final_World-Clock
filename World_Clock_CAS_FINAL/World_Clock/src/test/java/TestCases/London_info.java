...
public class London_info extends BaseClass {
	...
	void LondonWatch_Tittle() {
		...
		logger.info("-----7 test case for --------");
		  logger.info("lodon title sucess");
	}
	...
	void London_Time() {
		...
		logger.info("-----8 test case for --------");
		  logger.info("lodon time validation sucess");
	}
	...
	void London_Date() {
		...
		logger.info("-----9 test case for --------");
		  logger.info("london date validation sucess");
	}
	...
	void London_Timegap() {
		...
		logger.info("-----10 test case for --------");
		  logger.info("time gap validation sucess");      
	}
